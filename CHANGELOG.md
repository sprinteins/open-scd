...
## [0.36.0](https://github.com/sprinteins/open-scd/compare/v0.44.0...v0.36.0) (2026-01-19)
...
* **104/Address:** Added "Control" handling of CDC and first part of refactoring after discussion. ([8381d52](https://github.com/sprinteins/open-scd/commit/8381d525ff74cf676990d22cb38bbaf8a4a4c7b4))
* **104/Address:** Added logic to handle Check Addresses. ([2805261](https://github.com/sprinteins/open-scd/commit/28052611ec974f94cf68ebf4f5618dccfc944808))
* **104/Address:** Changed handling when/how Address with inverted attribute are created ([c047707](https://github.com/sprinteins/open-scd/commit/c047707a8514d9b4e910b42b0c009c7387c40d99))
* **104/CreateAddresses:** Use DO Template Structure to create DAI Elements ([748e2e5](https://github.com/sprinteins/open-scd/commit/748e2e531084b8ab223adefcc27c4dbfcc1a2498))
* **104/ExpectedValue:** Handling Enum Values as Expected Values in 104 address elements. ([5ccf677](https://github.com/sprinteins/open-scd/commit/5ccf677f18896e75a089e3534085b34bc1979cd6))
* **104/ShowDOIWizard:** Show detailed info about known/found TIs ([b55e405](https://github.com/sprinteins/open-scd/commit/b55e405c38555aaa4c2e9de4b82e1f4f7b7f4ccc))
* **104/Subnetworks:** Show/edit subnetworks with redundancy ([6f1e388](https://github.com/sprinteins/open-scd/commit/6f1e388916027fde3f15f8bdb86fec40403286e6))
...
* add commit lint to OpenSCD ([#1676](https://github.com/sprinteins/open-scd/issues/1676)) ([fffd1a7](https://github.com/sprinteins/open-scd/commit/fffd1a766f175044f78f34b0d833079dba34e085))
* add elements to virtual ied ([#1714](https://github.com/sprinteins/open-scd/issues/1714)) ([0c1074b](https://github.com/sprinteins/open-scd/commit/0c1074bf9d4f154a06c8031e593974c1f618fead))
...
* Add oscd api with plugin state ([#1696](https://github.com/sprinteins/open-scd/issues/1696)) ([1c457cf](https://github.com/sprinteins/open-scd/commit/1c457cf02a404a61b7ff09553223091bc5edd1f6))
* add Plugin Store ([8261706](https://github.com/sprinteins/open-scd/commit/82617064b81b8d68a9910b1bfcc1bf45fbbd9e71))
* add subscriber later binding plugin ([#1664](https://github.com/sprinteins/open-scd/issues/1664)) ([26f6900](https://github.com/sprinteins/open-scd/commit/26f690007cb5e7fe42b22f7fc46f18035d934008))
* add type distributor to plugins ([#18](https://github.com/sprinteins/open-scd/issues/18)) ([133efcd](https://github.com/sprinteins/open-scd/commit/133efcda78ea9697f0d2abc4a0ac241b5c32f8ab))
* add type-designer plugin to official plugin list ([e9d3e53](https://github.com/sprinteins/open-scd/commit/e9d3e53dec1d24a70e56b6e6f1d45d607f59829a))
* add virtual ied ([#1712](https://github.com/sprinteins/open-scd/issues/1712)) ([cf45fe9](https://github.com/sprinteins/open-scd/commit/cf45fe92e4a09066ca9b426b282486229dfbc43a))
...
* API compliant editor ([#1719](https://github.com/sprinteins/open-scd/issues/1719)) ([e43ee6a](https://github.com/sprinteins/open-scd/commit/e43ee6a10805d1d09e5a8adb539be7d68a65ab6a))
* Attach files to release build ([#1620](https://github.com/sprinteins/open-scd/issues/1620)) ([4f16a0d](https://github.com/sprinteins/open-scd/commit/4f16a0d4e7fa5d2c3d9c1cc2e6e1879d6c28e2f3))
...
* edit and delete virtual IED elements ([#1715](https://github.com/sprinteins/open-scd/issues/1715)) ([106688b](https://github.com/sprinteins/open-scd/commit/106688bd736b449a3182045ecb6fccc5a51067c7))
* Edit api v3 ([#1615](https://github.com/sprinteins/open-scd/issues/1615)) ([ce39e2b](https://github.com/sprinteins/open-scd/commit/ce39e2b7bfcda40659f36e40659b1efd571f2a53))
...
* **editors/ied:** Improve IED editor UI for IED and LN selection, closes [#1287](https://github.com/sprinteins/open-scd/issues/1287) ([e5bc0b8](https://github.com/sprinteins/open-scd/commit/e5bc0b8509a40950188e2f4bcf52569932309c69))
...
* **editors/laterbinding:** Filter later binding GOOSE/SMV by serviceType (closes [#1150](https://github.com/sprinteins/open-scd/issues/1150)) ([#1151](https://github.com/sprinteins/open-scd/issues/1151)) ([ea59f70](https://github.com/sprinteins/open-scd/commit/ea59f702546f1b9186054d77ec61f4ca57de5b10))
...
* **filtered-list:** filter on list item value ([#876](https://github.com/sprinteins/open-scd/issues/876)) ([9d7916b](https://github.com/sprinteins/open-scd/commit/9d7916bc684b338a076a84060ae317e4bf00cb83))
* Form library ([#1718](https://github.com/sprinteins/open-scd/issues/1718)) ([396bb13](https://github.com/sprinteins/open-scd/commit/396bb13d0d5ecf6c3994072f00958587bb9e5fcd))
...
* Make layout parts overwriteable ([#1692](https://github.com/sprinteins/open-scd/issues/1692)) ([b3822d2](https://github.com/sprinteins/open-scd/commit/b3822d27416baff13b358fca50f6a7dfe0eee50c))
...
* move gse smv between connectedAPs ([#1680](https://github.com/sprinteins/open-scd/issues/1680)) ([da8324e](https://github.com/sprinteins/open-scd/commit/da8324e08483a3b45dc7436d7c2e22381fa3c9e8))
...
* remove communication from the substation editor and use oscd-publisher plugin ([#1650](https://github.com/sprinteins/open-scd/issues/1650)) ([c850088](https://github.com/sprinteins/open-scd/commit/c8500880bfdffd87cf014a5ad1d9fcef89a5ba41))
...
* set up PR preview ([#1547](https://github.com/sprinteins/open-scd/issues/1547)) ([fede42b](https://github.com/sprinteins/open-scd/commit/fede42b43272e4fbf036e18df299a45fe52741cc))
...
* update nsd files ([#1691](https://github.com/sprinteins/open-scd/issues/1691)) ([c437f5a](https://github.com/sprinteins/open-scd/commit/c437f5acaf5a45032cfae559ecf70de968913d45))
* update release please action ([#1635](https://github.com/sprinteins/open-scd/issues/1635)) ([06b8356](https://github.com/sprinteins/open-scd/commit/06b8356485940f2841b01293de5bea2a6fa1399d))
...
* **104/address:** Input fields are reset when using multiple time ([1d31358](https://github.com/sprinteins/open-scd/commit/1d313580cb377cec75c11fd718014c703a6fbf4b))
...
* **104:** Temporary fix to refresh components. ([41a0a4b](https://github.com/sprinteins/open-scd/commit/41a0a4bb046787d20a38e0198a4449dff001f9e6))
...
* Adding Subnetwork to a configuration without a Communication Ele… ([0f661d4](https://github.com/sprinteins/open-scd/commit/0f661d467f40d6c40df85269846b6c8a34832a4a))
...
* Attach release files in release please ([#1636](https://github.com/sprinteins/open-scd/issues/1636)) ([f2e6a1d](https://github.com/sprinteins/open-scd/commit/f2e6a1d8b8fc49b03c75e94dfeed565eeb1bda2f))
* Build entire project and attach distribution to build output ([#1639](https://github.com/sprinteins/open-scd/issues/1639)) ([bd554e7](https://github.com/sprinteins/open-scd/commit/bd554e72f308a3c6e60f4ee1d98fa4884fc5d8f8))
* change pattern definition of tIDNaming to non-whitespace characters ([#1670](https://github.com/sprinteins/open-scd/issues/1670)) ([5476bd0](https://github.com/sprinteins/open-scd/commit/5476bd08711ae94341802db0636dcfd0e231cd41))
...
* **communication-plugin:** Offer only valid connected aps as move targets ([#1685](https://github.com/sprinteins/open-scd/issues/1685)) ([bfd43ba](https://github.com/sprinteins/open-scd/commit/bfd43bab3e164d15f7aa2bafe5d0d428df9d10e7))
...
* Connected AP wizard element order ([#1703](https://github.com/sprinteins/open-scd/issues/1703)) ([cd3b39a](https://github.com/sprinteins/open-scd/commit/cd3b39ad45b6ddfc5d8c3641a5c120dd95bb5dd6))
* continue to upload assets job even if npm publish step fails ([#1638](https://github.com/sprinteins/open-scd/issues/1638)) ([bc7571e](https://github.com/sprinteins/open-scd/commit/bc7571e8351d2a1770e19c58eabf91404cf1726e))
* correct plug-ins' paths ([a7a14ce](https://github.com/sprinteins/open-scd/commit/a7a14ced59294d8a24daabf5ecdc76a5dbb75237))
* Disable experimental require module to make node 20.19 and above work ([#1709](https://github.com/sprinteins/open-scd/issues/1709)) ([d47a3da](https://github.com/sprinteins/open-scd/commit/d47a3dac6c57ee814cfbd78f3636fe872a052568))
...
* **editor/104:** Small improvements and fix. ([#874](https://github.com/sprinteins/open-scd/issues/874)) ([eb22280](https://github.com/sprinteins/open-scd/commit/eb222802b70162c7748938b593b15dd35312b96c))
...
* Fix handle activate editor ([#1651](https://github.com/sprinteins/open-scd/issues/1651)) ([3847944](https://github.com/sprinteins/open-scd/commit/384794420292a9e5192eac937d907238a6113120))
...
* **gh-action:** build-and-deploy should first build core before building OpenSCD ([#1427](https://github.com/sprinteins/open-scd/issues/1427)) ([e25e5f8](https://github.com/sprinteins/open-scd/commit/e25e5f8c94457deeed207891fec3234201fb1a03))
...
* **Import IED:** Fix order of edits ([#1698](https://github.com/sprinteins/open-scd/issues/1698)) ([0831fa4](https://github.com/sprinteins/open-scd/commit/0831fa4e4cde55a21c261b1b4b8b5994868509b0))
...
* modify start script to clear snowpack cache ([#1654](https://github.com/sprinteins/open-scd/issues/1654)) ([ff699e3](https://github.com/sprinteins/open-scd/commit/ff699e357442593f07bf9665473b1fbc499606b0))
* Move menu item content outside drawer ([#1683](https://github.com/sprinteins/open-scd/issues/1683)) ([15b2872](https://github.com/sprinteins/open-scd/commit/15b287240a015ab49590d6a4ab094f9180a16917))
...
* re-enable input fields in custom plugins dialog ([#1541](https://github.com/sprinteins/open-scd/issues/1541)) ([38b490d](https://github.com/sprinteins/open-scd/commit/38b490d1ca7988cebef8513fb640eb077c6246a0))
...
* rename releases_created into release_created for release_please_action@V4 ([#1641](https://github.com/sprinteins/open-scd/issues/1641)) ([81801cc](https://github.com/sprinteins/open-scd/commit/81801cc776311ff996c512ea2f441b2b9cc5e2cd))
* Require lnInst only for regular lns ([#1713](https://github.com/sprinteins/open-scd/issues/1713)) ([003161f](https://github.com/sprinteins/open-scd/commit/003161fd5a0b363477ece059629ed2c0d6d86aa0))
* Settings addon translations ([cd3b39a](https://github.com/sprinteins/open-scd/commit/cd3b39ad45b6ddfc5d8c3641a5c120dd95bb5dd6))
* **Settings:** Allow missmatched nsdoc import ([#1690](https://github.com/sprinteins/open-scd/issues/1690)) ([287d0f0](https://github.com/sprinteins/open-scd/commit/287d0f070ca1deaa88148ce16c67aa51407f4000))
* **Settings:** Make language loader configureable ([#1693](https://github.com/sprinteins/open-scd/issues/1693)) ([5205a9f](https://github.com/sprinteins/open-scd/commit/5205a9f751d8e9dbc0cb5b2630af39c31dc09460))
...
* update deprecated ubuntu image in pr-preview workflow ([#1665](https://github.com/sprinteins/open-scd/issues/1665)) ([f9f5e45](https://github.com/sprinteins/open-scd/commit/f9f5e450dee98fe3c5192f50d8ecb302be666705))
* update node  to 20.x in release workflow ([#1716](https://github.com/sprinteins/open-scd/issues/1716)) ([115f22a](https://github.com/sprinteins/open-scd/commit/115f22a6f1f9cfe02a4817ec03811bcc53cd1fea))
* update release please version to 0.37.2 ([#1632](https://github.com/sprinteins/open-scd/issues/1632)) ([a3d6d2f](https://github.com/sprinteins/open-scd/commit/a3d6d2f68952e98d62375b037b5b36bca63f325a))
