...
## [0.34.0](https://github.com/sprinteins/open-scd/compare/v0.35.0...v0.34.0) (2024-10-28)
...
* **Editing:** check globally for ID uniqueness ([c2b14fb](https://github.com/sprinteins/open-scd/commit/c2b14fb337adb9f55874dbb3add0aefda8622946))
...
* **editors/cleanup:** remove unused control blocks ([#620](https://github.com/sprinteins/open-scd/issues/620)) ([e63f11f](https://github.com/sprinteins/open-scd/commit/e63f11f9e5e2130b273506eff2567ec31a890f57))
...
* **editors/cleanup:** unreferenced DataSet ([#568](https://github.com/sprinteins/open-scd/issues/568)) ([edc133c](https://github.com/sprinteins/open-scd/commit/edc133cdecce61abf53d043bc45292d1a1a36c7c))
...
* **editors/subscriber:** use filtered lists ([#638](https://github.com/sprinteins/open-scd/issues/638)) ([f255bfb](https://github.com/sprinteins/open-scd/commit/f255bfb4f205239413f12f7c47e221e739cefdce))
...
* **editors/Subscription:** When undo / redo actions Subscription / SMV plugin, lists are not refreshed ([7889be9](https://github.com/sprinteins/open-scd/commit/7889be93b7d8f76042cc08656392b83f1b82dada))
...
* **editors/Substation:** Add PowerTransformer Components to Substation Editor ([22555b6](https://github.com/sprinteins/open-scd/commit/22555b6713c9f2c8e882269ffce9a826d016e87b))
...
* **editors/template/lnodetype-wizards:** make use of -7-420 NSD ([0a2d5a4](https://github.com/sprinteins/open-scd/commit/0a2d5a40c50d5a0cc66fd7c5b31f6493aa7c4600))
...
* **ied-editor/ln-node:** Changed description of LN Node in IED Editor ([#647](https://github.com/sprinteins/open-scd/issues/647)) ([9a655e8](https://github.com/sprinteins/open-scd/commit/9a655e88d1a8341ec56a83c6af540e77f4e9c280))
...
* **plugins/IED:** Add icon set to IED editor containers ([9878259](https://github.com/sprinteins/open-scd/commit/9878259665be2e34bd99dd1d5f72c1944b3dca1f))
* **plugins/IED:** Added Functional Constraint value to DA Container. ([f389c2c](https://github.com/sprinteins/open-scd/commit/f389c2cf7595f9c2486dff0ef0f40a5feff028fb))
* **plugins/SampledValues:** Create Sampled Values tab in Subscription plugin ([f94b042](https://github.com/sprinteins/open-scd/commit/f94b0422253940785a0982ae72910f1bbbc2ac62))
* **plugins/SampledValues:** Small bug fix + Added Integration tests ([a58f305](https://github.com/sprinteins/open-scd/commit/a58f305c78a65c056c617e9f09e8d648f4aaf610))
...
* **plugins/Subscription:** Create 'Subscription' plugin for GOOSE subscriptions ([25fae6f](https://github.com/sprinteins/open-scd/commit/25fae6fc42ad76f269ef029848d5cae6329eee33))
...
* **wizard-dialog:** allow used-defined actions in menu ([f8c5a93](https://github.com/sprinteins/open-scd/commit/f8c5a93100e4c7e922627337ffee32f6169b12cf))
* **wizard-dialog:** wizard-dialog content definition through `WizardInput` objects ([5f3a7a7](https://github.com/sprinteins/open-scd/commit/5f3a7a7c4a74bffb5e800b8c75bffdbdb3213e15))
...
* **wizards/dai:** Change DAI values ([#687](https://github.com/sprinteins/open-scd/issues/687)) ([3689ef2](https://github.com/sprinteins/open-scd/commit/3689ef26253ba3c352f0bd758b9abdbc17fe9c33))
...
* **wizards/gsecontrol:** add create wizards ([#654](https://github.com/sprinteins/open-scd/issues/654)) ([887f46f](https://github.com/sprinteins/open-scd/commit/887f46f5e3bc885cfad1f9e18a2d5f58161fbb44))
...
* **wizards/reportcontrol:** add copy to other IEDs  ([#632](https://github.com/sprinteins/open-scd/issues/632)) ([1850dfa](https://github.com/sprinteins/open-scd/commit/1850dfa6c77669fd47ac36379a32267dc54ef913))
* **wizards/reportcontrol:** add create wizard ([#544](https://github.com/sprinteins/open-scd/issues/544)) ([546419f](https://github.com/sprinteins/open-scd/commit/546419f31afe82ebf1315e2acce59e11f97d8ca8))
...
* **wizards:** Changed label of rptID ([#697](https://github.com/sprinteins/open-scd/issues/697)) ([10f3f0b](https://github.com/sprinteins/open-scd/commit/10f3f0bdea05328838196914f62290e4ca6c76bc))
...
* **action-pane:** adjust css rules for icon slot ([#594](https://github.com/sprinteins/open-scd/issues/594)) ([8bc0549](https://github.com/sprinteins/open-scd/commit/8bc0549bc791ef6b7fe0b1dfd4d5a6f1dfccde2d))
...
* **editors/subscription:** several styling issues ([#661](https://github.com/sprinteins/open-scd/issues/661)) ([b9f5555](https://github.com/sprinteins/open-scd/commit/b9f5555c4c01c7ba29cfca12dd5f0b318abee861))
...
* **editors/template:** on id attribute update adopt references as well ([#590](https://github.com/sprinteins/open-scd/issues/590)) ([af246dd](https://github.com/sprinteins/open-scd/commit/af246ddcde907688081aaa20d295faeb978b0a6f))
* **editors/template:** properly update xxxType list after add/editing ([#582](https://github.com/sprinteins/open-scd/issues/582)) ([2e11cc8](https://github.com/sprinteins/open-scd/commit/2e11cc8c277d31dd693ae54656e1c3b4cd23f8f3))
* **editors:** Changed selectors in Substation and IED Editors and updated IED and Substation Wizards. ([#671](https://github.com/sprinteins/open-scd/issues/671)) ([33b590a](https://github.com/sprinteins/open-scd/commit/33b590abdedca12d1029d950654d8d6673124e8f))
...
* **filtered-list:** allow filter nested list-item s ([#660](https://github.com/sprinteins/open-scd/issues/660)) ([1ea37c5](https://github.com/sprinteins/open-scd/commit/1ea37c5c490de52b538201d3a4fb39291b239771))
...
* **wizard-dialog:** make sure to close on non empty editor action ([8fb125c](https://github.com/sprinteins/open-scd/commit/8fb125c1c353feb37a4c988d59a608090fb0425b))
* **wizard-dialog:** remove initialFocus from action buttons ([#702](https://github.com/sprinteins/open-scd/issues/702)) ([a4783ab](https://github.com/sprinteins/open-scd/commit/a4783ab46e350e5ed1af64102bd3a78e95fc2c93))
...
* **wizards/subnetwork:** incorrect title for create wizard ([#645](https://github.com/sprinteins/open-scd/issues/645)) ([0210913](https://github.com/sprinteins/open-scd/commit/0210913cc8eef9cf06d1071a146072ba24e80df0))
